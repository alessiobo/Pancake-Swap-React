        ...
        {isFarmsDataVisible ? (
          <div className="farms-data">
            <div className="data-item1">
              ...
              <p className="data-paragraph">130.320%</p>
            ...
            <div className="data-item2">
              ...
              <p className="data-paragraph">122.320%</p>
              <p className="data-initials">APR</p>
            </div>
            <div className="data-item3">
              ...
              <p className="data-paragraph">116.840%</p>
              <p className="data-initials">APR</p>
            </div>
            <div className="data-item4">
              ...
              <p className="data-paragraph">102.034%</p>
              <p className="data-initials">APR</p>
            </div>
            <div className="data-item5">
              ...
              <p className="data-paragraph">98.997%</p>
              <p className="data-initials">APR</p>
            </div>
          </div>
        ) : (
          <div className="syrup-data">
            <div className="data-item1">
              ...
              <p className="data-paragraph">59.14%</p>
              <p className="data-initials">APR</p>
            </div>
            <div className="data-item2">
              <h5 className="small-title">
              ...
              <p className="data-paragraph">6.216%</p>
              <p className="data-initials">APR</p>
            </div>
            <div className="data-item3">
              <h5 className="small-title">
              ...
              <p className="data-paragraph">6.203%</p>
              <p className="data-initials">APR</p>
            </div>
            <div className="data-item4">
              <h5 className="small-title">
              ...
              <p className="data-paragraph">6.089%</p>
              <p className="data-initials">APR</p>
            </div>
            <div className="data-item5">
              <h5 className="small-title">
              ...
              <p className="data-paragraph">5.686%</p>
              <p className="data-initials">APR</p>
            </div>
          </div>
        )}
